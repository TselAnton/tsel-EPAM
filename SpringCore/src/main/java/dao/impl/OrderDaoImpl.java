...
public class OrderDaoImpl implements OrderDao {
    ...
    public OrderDaoImpl(ConnectionController connectionController) {
    ...
    public List<Order> getAllOrdersByUserId(int userId) {
        List<Order> orders = arraysGenerator.generateArrayList();
    ...
    private List<Order> getOrdersByResultSet(ResultSet rs) {
        List<Order> orderList = arraysGenerator.generateArrayList();
        try {
            while (rs.next()) {
